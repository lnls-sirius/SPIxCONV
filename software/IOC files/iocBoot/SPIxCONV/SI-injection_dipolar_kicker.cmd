...
# database for 30 kV Voltage source:
dbLoadRecords("database/SPIxCONV.db", "PREFIX = SI-01SA:PU-InjDpKckr, SCAN_RATE = .1 second, SPIxCONV_ADDRESS = 1, VOLTAGE_FACTOR = 3000.0")
