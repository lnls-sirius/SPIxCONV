...
# database for 15 kV Voltage source:
dbLoadRecords("database/SPIxCONV_NLK_OnAxis.db", "PREFIX = SI-01SA:PU-InjNLKckr, SCAN_RATE = .1 second, SPIxCONV_ADDRESS = 1, VOLTAGE_FACTOR = 1500.0")
