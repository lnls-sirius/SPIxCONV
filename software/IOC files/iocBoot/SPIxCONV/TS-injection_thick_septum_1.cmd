...
# database for 1 kV Voltage source:
dbLoadRecords("database/SPIxCONV.db", "PREFIX = TS-04:PU-InjSeptG-1, SCAN_RATE = .1 second, SPIxCONV_ADDRESS = 1, VOLTAGE_FACTOR = 100.0")
